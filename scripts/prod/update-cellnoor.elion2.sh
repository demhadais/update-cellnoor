...
uv run main.py --config-path /sc/service/.config/update-cellnoor/update-cellnoor.toml /sc/service/delivery/*/10x-genomics/25E* /sc/service/delivery/*/10x-genomics/26CH* /sc/service/delivery/*/chromium/25E* /sc/service/delivery/*/chromium/26CH*
